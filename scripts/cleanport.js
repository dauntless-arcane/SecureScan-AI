#!/usr/bin/env node
// Kills whatever process is listening on the frontend port (default 5173),
// so an orphaned `vite` dev server doesn't grab a different port on the next `npm run dev`.
